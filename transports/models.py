...
class CMR(models.Model):
    ...
    loc_livrare = models.CharField(max_length=255, blank=True, null=True)
    loc_incarcare = models.CharField(max_length=255, blank=True, null=True)
    data_incarcare = models.DateField(blank=True, null=True)
    marci_numere = models.CharField(max_length=255, blank=True, null=True)
    numar_colete = models.IntegerField(blank=True, null=True)
    mod_ambalare = models.CharField(max_length=255, blank=True, null=True)
    natura_marfii = models.CharField(max_length=255, blank=True, null=True)
    nr_static = models.CharField(max_length=100, blank=True, null=True)
    greutate_bruta = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
    cubaj = models.DecimalField(max_digits=10, decimal_places=2, blank=True, null=True)
